...
| Tool-use safety | AgentDojo control matrix; ToolEmu gateway and upstream-emulator contracts passed | AgentDojo: 48 native trials, 35 useful, 0 injected tasks satisfied; ToolEmu: no-cost schema, upstream simulator, and receipt contracts only |
